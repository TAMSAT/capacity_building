...
rain     = pd.read_csv('02-tamsatPentadal.v3.1-1506812400-1525129200_zam.csv', index_col=0, parse_dates=True)
rainanom = pd.read_csv('02a-tamsatPentadalAnomalies.v3.1-1506812400-1525129200_zam.csv', index_col=0, parse_dates=True)
...
rain_nc     = xr.open_dataset('04-tamsatMonthly.v3.1-1506812400-1525129200_21.8_34.0_-18.3_-8.0.nc')
rainanom_nc = xr.open_dataset('04a-tamsatMonthlyAnomalies.v3.1-1506812400-1525129200_21.8_34.0_-18.3_-8.0.nc')
